...
for i in range(n): # можно было сделать один цикл и обрабатывать инфу сразу после ее получения,
    # что уменьшает цикломатическую сложность кода и увеличивает читаемость
